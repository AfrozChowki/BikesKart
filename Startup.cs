...
namespace BikesKart
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //    options => options.UseSqlServer("Server=\\SQLEXPRESS;Database=BikeStores;Trusted_Connection=True;TrustServerCertificate=True;"));

            services.AddTransient<BikeStoresContext, BikeStoresContext>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "BikesKart v1"));
            }
